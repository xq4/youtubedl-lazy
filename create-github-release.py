...
class GitHubReleaser(object):
    _API_URL = 'https://api.github.com/repos/xq4/youtubedl-lazy/releases'
    _UPLOADS_URL = 'https://uploads.github.com/repos/xq4/youtubedl-lazy/releases/%s/assets?name=%s'
